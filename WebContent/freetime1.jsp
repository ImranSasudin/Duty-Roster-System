						...
						<div class="col-2-3">
							<div class="wrap-col">
								<div class="contact">
									...
									<!-- START OF FORM -->
										...
										<form name="form1" method="post" id="ff" action="freetimeController">
											<label class="row">
												<div class="col-1-2">
													<div class="wrap-col">
														<input type="text" name="id" id="id" value="<c:out value="<%=id%>"/>" required>
													</div>
												</div>
											</label>
											<label class="row">
											...
											<label class="row">
												<div class="col-1-2">
													<div class="wrap-col">
														DATE: <input type="date" name="freeDate" id="freeDate" required>
													</div>
												</div>
											</label>
											<label class="row">
							...
							<table class="table table-bordered table-hover table-striped" align="center" style="width:450px;">
                              ...
                              <table class="table table-bordered table-hover table-striped" align="center" style="width:450px;">
                						...
                						<c:forEach items="${notFrees}" var="notFree">
                						<tr>
                							<td><c:out value="${notFree.freeDate}"/></td>
                							<td><c:out value="${notFree.status}"/></td>
                						</tr>
                						</c:forEach> 	
                              </table>
                              </div>
